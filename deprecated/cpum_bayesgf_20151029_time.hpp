...
public:
    cpum_bayesgf_20151029_time_model(stan::io::var_context& context__,
        ...
        context__.validate_dims("data initialization", "atwork", "int", context__.to_vec(obscomplete));
        validate_non_negative_index("atwork", "obscomplete", obscomplete);
        atwork = std::vector<int>(obscomplete,int(0));
        vals_i__ = context__.vals_i("atwork");
        pos__ = 0;
        size_t atwork_limit_0__ = obscomplete;
        for (size_t i_0__ = 0; i_0__ < atwork_limit_0__; ++i_0__) {
            atwork[i_0__] = vals_i__[pos__++];
        }
        ...
        for (int k0__ = 0; k0__ < obscomplete; ++k0__) {
            check_greater_or_equal(function__,"atwork[k0__]",atwork[k0__],0);
            check_less_or_equal(function__,"atwork[k0__]",atwork[k0__],1);
        }
        for (int k0__ = 0; k0__ < obscomplete; ++k0__) {
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        context__.validate_dims("initialization", "a", "double", context__.to_vec(2));
        ...
        pos__ = 0U;
        context__.validate_dims("initialization", "b", "double", context__.to_vec(2));
        std::vector<double> b(2,double(0));
        for (int i0__ = 0U; i0__ < 2; ++i0__)
        ...
        pos__ = 0U;
        context__.validate_dims("initialization", "c", "double", context__.to_vec(2));
        std::vector<double> c(2,double(0));
        for (int i0__ = 0U; i0__ < 2; ++i0__)
        ...
        pos__ = 0U;
        context__.validate_dims("initialization", "g", "double", context__.to_vec(2));
        std::vector<double> g(2,double(0));
        for (int i0__ = 0U; i0__ < 2; ++i0__)
        ...
        try {
            ...
            for (int n = 1; n <= obscomplete; ++n) {
                ...
                if (as_bool((primitive_value(logical_eq(get_base1(atwork,n,"atwork",1),1)) && primitive_value(logical_gt(get_base1(wlm,n,"wlm",1),0))))) {
                    ...
                    lp_accum__.add(normal_log<propto__>(log((get_base1(wlm,n,"wlm",1) / 1000)), (g0 + (get_base1(g,1,"g",1) * get_base1(ageoutcen,n,"ageoutcen",1))), sigma2));
                } else {
                ...
                if (as_bool((primitive_value(logical_eq(get_base1(atwork,n,"atwork",1),1)) || primitive_value(logical_eq(get_base1(leftwork,n,"leftwork",1),1))))) {
                    ...
                    lp_accum__.add(bernoulli_logit_log<propto__>(get_base1(leftwork,n,"leftwork",1), (a0 + (get_base1(a,1,"a",1) * get_base1(ageoutcen,n,"ageoutcen",1)))));
                } else {
            ...
            lp_accum__.add(bernoulli_logit_log<propto__>(d_lc, add(add(b0,multiply(get_base1(b,1,"b",1),ageoutcen)),elt_multiply(multiply(get_base1(b,2,"b",1),ageoutcen),ageoutcen))));
            current_statement_begin__ = 156;
            lp_accum__.add(bernoulli_logit_log<propto__>(d_nonlc, add(add(c0,multiply(get_base1(c,1,"c",1),ageoutcen)),elt_multiply(multiply(get_base1(c,2,"c",1),ageoutcen),ageoutcen))));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e,current_statement_begin__);
            // Next line prevents compiler griping about no return
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("y_nc");
        names__.push_back("ylc");
        names__.push_back("ynlc");
    }
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        double meanCumX(0.0);
        (void) meanCumX;  // dummy to suppress unused var warning
        double meanWkyrs(0.0);
        (void) meanWkyrs;  // dummy to suppress unused var warning
        vector<double> y_nc(J, 0.0);
        ...
        stan::math::fill(y_nc,DUMMY_VAR__);
        stan::math::fill(ylc,DUMMY_VAR__);
        stan::math::fill(ynlc,DUMMY_VAR__);
        ...
        try {
            {
                ...
                stan::math::assign(meanCumX, 0);
                current_statement_begin__ = 208;
                stan::math::assign(meanWkyrs, 0);
                ...
                for (int n = 1; n <= obs; ++n) {
                    ...
                    if (as_bool(logical_eq(lswitch,1))) {
                        ...
                        stan::math::assign(get_base1_lhs(leftworkf,n,"leftworkf",1), bernoulli_rng(inv_logit((a0 + (get_base1(a,1,"a",1) * get_base1(time_fullcen,n,"time_fullcen",1)))), base_rng__));
                    ...
                    if (as_bool(logical_eq(get_base1(lhat,n,"lhat",1),1))) {
                        ...
                        stan::math::assign(get_base1_lhs(xhat,n,"xhat",1), (1000 * exp(normal_rng((g0 + (get_base1(g,1,"g",1) * get_base1(time_fullcen,n,"time_fullcen",1))),sigma2, base_rng__))));
                    ...
                    stan::math::assign(get_base1_lhs(h_lcn,n,"h_lcn",1), inv_logit(((b0 + (get_base1(b,1,"b",1) * get_base1(time_fullcen,n,"time_fullcen",1))) + ((get_base1(b,2,"b",1) * get_base1(time_fullcen,n,"time_fullcen",1)) * get_base1(time_fullcen,n,"time_fullcen",1)))));
                    current_statement_begin__ = 281;
                    stan::math::assign(get_base1_lhs(h_nlcn,n,"h_nlcn",1), inv_logit(((c0 + (get_base1(c,1,"c",1) * get_base1(time_fullcen,n,"time_fullcen",1))) + ((get_base1(c,2,"c",1) * get_base1(time_fullcen,n,"time_fullcen",1)) * get_base1(time_fullcen,n,"time_fullcen",1)))));
                    ...
                    if (as_bool((primitive_value(logical_eq(get_base1(time_full,n,"time_full",1),maxT)) || primitive_value(logical_eq(get_base1(time_full,n,"time_full",1),get_base1(maxage_full,n,"maxage_full",1)))))) {
                        ...
                        stan::math::assign(meanCumX, (meanCumX + (get_base1(cumx,n,"cumx",1) / N)));
                    }
                }
                ...
                for (int k = 1; k <= J; ++k) {
                    ...
                    stan::math::assign(get_base1_lhs(y_nc,k,"y_nc",1), (get_base1(ylc,k,"ylc",1) + get_base1(ynlc,k,"ynlc",1)));
                }
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        vars__.push_back(meanCumX);
        vars__.push_back(meanWkyrs);
        for (int k_0__ = 0; k_0__ < J; ++k_0__) {
            vars__.push_back(y_nc[k_0__]);
        }
        for (int k_0__ = 0; k_0__ < J; ++k_0__) {
            vars__.push_back(ylc[k_0__]);
        }
        for (int k_0__ = 0; k_0__ < J; ++k_0__) {
            vars__.push_back(ynlc[k_0__]);
        }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_name_stream__.str(std::string());
        param_name_stream__ << "meanCumX";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "meanWkyrs";
        param_names__.push_back(param_name_stream__.str());
        for (int k_0__ = 1; k_0__ <= J; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "y_nc" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= J; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "ylc" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= J; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "ynlc" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
    }
