...
namespace cpum_bayesgf_20151101_model_namespace {
...
class cpum_bayesgf_20151101_model : public prob_grad {
private:
    int N;
    int J;
    int minT;
    ...
    row_vector_d ageout;
    row_vector_d yearout;
    row_vector_d cohort_1;
    row_vector_d BL_cumwlm;
    row_vector_d BL_cumatwork;
    row_vector_d cumatwork;
    vector<int> leftwork;
    vector<int> d_lc;
    vector<int> d_nonlc;
    row_vector_d id_full;
    row_vector_d cohort_1_full;
    row_vector_d time_full;
    row_vector_d year_full;
    row_vector_d smoke3_2_full;
    row_vector_d minage_full;
    row_vector_d maxage_full;
    row_vector_d BL_cumwlm_full;
    row_vector_d BL_cumatwork_full;
    row_vector_d logwlm;
    row_vector_d ageoutcen;
    row_vector_d yearoutcen;
    row_vector_d BL_cumwlmcen;
    row_vector_d BL_cumatworkcen;
    row_vector_d cumatworkcen;
    row_vector_d cumwlm2lagcen;
    row_vector_d over50;
    row_vector_d time_fullcen;
    row_vector_d year_fullcen;
    row_vector_d BL_cumwlm_fullcen;
    row_vector_d BL_cumatwork_fullcen;
    double meanageout;
    double sdageout;
    double meanyearout;
    double sdyearout;
    double meanBL_cumwlm;
    double meanBL_cumatwork;
    double meancumatwork;
    double meancumwlm2lag;
    double sdBL_cumwlm;
    double sdBL_cumatwork;
    double sdcumatwork;
    double sdcumwlm2lag;
public:
    cpum_bayesgf_20151101_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        current_statement_begin__ = -1;

        static const char* function__ = "cpum_bayesgf_20151101_model_namespace::cpum_bayesgf_20151101_model";
        ...
        context__.validate_dims("data initialization", "yearout", "row_vector_d", context__.to_vec(obscomplete));
        validate_non_negative_index("yearout", "obscomplete", obscomplete);
        yearout = row_vector_d(obscomplete);
        vals_r__ = context__.vals_r("yearout");
        pos__ = 0;
        size_t yearout_i_vec_lim__ = obscomplete;
        for (size_t i_vec__ = 0; i_vec__ < yearout_i_vec_lim__; ++i_vec__) {
            yearout[i_vec__] = vals_r__[pos__++];
        }
        ...
        context__.validate_dims("data initialization", "BL_cumatwork", "row_vector_d", context__.to_vec(obscomplete));
        validate_non_negative_index("BL_cumatwork", "obscomplete", obscomplete);
        BL_cumatwork = row_vector_d(obscomplete);
        vals_r__ = context__.vals_r("BL_cumatwork");
        pos__ = 0;
        size_t BL_cumatwork_i_vec_lim__ = obscomplete;
        for (size_t i_vec__ = 0; i_vec__ < BL_cumatwork_i_vec_lim__; ++i_vec__) {
            BL_cumatwork[i_vec__] = vals_r__[pos__++];
        }
        context__.validate_dims("data initialization", "cumatwork", "row_vector_d", context__.to_vec(obscomplete));
        validate_non_negative_index("cumatwork", "obscomplete", obscomplete);
        cumatwork = row_vector_d(obscomplete);
        vals_r__ = context__.vals_r("cumatwork");
        pos__ = 0;
        size_t cumatwork_i_vec_lim__ = obscomplete;
        for (size_t i_vec__ = 0; i_vec__ < cumatwork_i_vec_lim__; ++i_vec__) {
            cumatwork[i_vec__] = vals_r__[pos__++];
        }
        ...
        context__.validate_dims("data initialization", "time_full", "row_vector_d", context__.to_vec(obs));
        validate_non_negative_index("time_full", "obs", obs);
        time_full = row_vector_d(obs);
        vals_r__ = context__.vals_r("time_full");
        pos__ = 0;
        size_t time_full_i_vec_lim__ = obs;
        for (size_t i_vec__ = 0; i_vec__ < time_full_i_vec_lim__; ++i_vec__) {
            time_full[i_vec__] = vals_r__[pos__++];
        }
        context__.validate_dims("data initialization", "year_full", "row_vector_d", context__.to_vec(obs));
        validate_non_negative_index("year_full", "obs", obs);
        year_full = row_vector_d(obs);
        vals_r__ = context__.vals_r("year_full");
        pos__ = 0;
        size_t year_full_i_vec_lim__ = obs;
        for (size_t i_vec__ = 0; i_vec__ < year_full_i_vec_lim__; ++i_vec__) {
            year_full[i_vec__] = vals_r__[pos__++];
        }
        ...
        context__.validate_dims("data initialization", "BL_cumatwork_full", "row_vector_d", context__.to_vec(obs));
        validate_non_negative_index("BL_cumatwork_full", "obs", obs);
        BL_cumatwork_full = row_vector_d(obs);
        vals_r__ = context__.vals_r("BL_cumatwork_full");
        pos__ = 0;
        size_t BL_cumatwork_full_i_vec_lim__ = obs;
        for (size_t i_vec__ = 0; i_vec__ < BL_cumatwork_full_i_vec_lim__; ++i_vec__) {
            BL_cumatwork_full[i_vec__] = vals_r__[pos__++];
        }
        ...
        validate_non_negative_index("logwlm", "obscomplete", obscomplete);
        logwlm = row_vector_d(obscomplete);
        validate_non_negative_index("ageoutcen", "obscomplete", obscomplete);
        ageoutcen = row_vector_d(obscomplete);
        validate_non_negative_index("yearoutcen", "obscomplete", obscomplete);
        yearoutcen = row_vector_d(obscomplete);
        validate_non_negative_index("BL_cumwlmcen", "obscomplete", obscomplete);
        BL_cumwlmcen = row_vector_d(obscomplete);
        validate_non_negative_index("BL_cumatworkcen", "obscomplete", obscomplete);
        BL_cumatworkcen = row_vector_d(obscomplete);
        validate_non_negative_index("cumatworkcen", "obscomplete", obscomplete);
        cumatworkcen = row_vector_d(obscomplete);
        validate_non_negative_index("cumwlm2lagcen", "obscomplete", obscomplete);
        cumwlm2lagcen = row_vector_d(obscomplete);
        validate_non_negative_index("over50", "obscomplete", obscomplete);
        over50 = row_vector_d(obscomplete);
        validate_non_negative_index("time_fullcen", "obs", obs);
        time_fullcen = row_vector_d(obs);
        validate_non_negative_index("year_fullcen", "obs", obs);
        year_fullcen = row_vector_d(obs);
        validate_non_negative_index("BL_cumwlm_fullcen", "obs", obs);
        BL_cumwlm_fullcen = row_vector_d(obs);
        validate_non_negative_index("BL_cumatwork_fullcen", "obs", obs);
        BL_cumatwork_fullcen = row_vector_d(obs);
        meanageout = double(0);
        sdageout = double(0);
        meanyearout = double(0);
        sdyearout = double(0);
        meanBL_cumwlm = double(0);
        meanBL_cumatwork = double(0);
        meancumatwork = double(0);
        meancumwlm2lag = double(0);
        sdBL_cumwlm = double(0);
        sdBL_cumatwork = double(0);
        sdcumatwork = double(0);
        ...
        stan::math::fill(logwlm,DUMMY_VAR__);
        stan::math::fill(ageoutcen,DUMMY_VAR__);
        stan::math::fill(yearoutcen,DUMMY_VAR__);
        stan::math::fill(BL_cumwlmcen,DUMMY_VAR__);
        stan::math::fill(BL_cumatworkcen,DUMMY_VAR__);
        stan::math::fill(cumatworkcen,DUMMY_VAR__);
        stan::math::fill(cumwlm2lagcen,DUMMY_VAR__);
        stan::math::fill(over50,DUMMY_VAR__);
        stan::math::fill(time_fullcen,DUMMY_VAR__);
        stan::math::fill(year_fullcen,DUMMY_VAR__);
        stan::math::fill(BL_cumwlm_fullcen,DUMMY_VAR__);
        stan::math::fill(BL_cumatwork_fullcen,DUMMY_VAR__);
        stan::math::fill(meanageout,DUMMY_VAR__);
        stan::math::fill(sdageout,DUMMY_VAR__);
        stan::math::fill(meanyearout,DUMMY_VAR__);
        stan::math::fill(sdyearout,DUMMY_VAR__);
        stan::math::fill(meanBL_cumwlm,DUMMY_VAR__);
        stan::math::fill(meanBL_cumatwork,DUMMY_VAR__);
        stan::math::fill(meancumatwork,DUMMY_VAR__);
        stan::math::fill(meancumwlm2lag,DUMMY_VAR__);
        stan::math::fill(sdBL_cumwlm,DUMMY_VAR__);
        stan::math::fill(sdBL_cumatwork,DUMMY_VAR__);
        stan::math::fill(sdcumatwork,DUMMY_VAR__);
        ...
        try {
            ...
            stan::math::assign(meanyearout, mean(yearout));
            current_statement_begin__ = 82;
            stan::math::assign(meanBL_cumwlm, mean(BL_cumwlm));
            current_statement_begin__ = 83;
            stan::math::assign(meanBL_cumatwork, mean(BL_cumatwork));
            current_statement_begin__ = 84;
            stan::math::assign(meancumatwork, mean(cumatwork));
            current_statement_begin__ = 85;
            stan::math::assign(meancumwlm2lag, mean(cumwlm2lag));
            current_statement_begin__ = 86;
            stan::math::assign(sdageout, sd(ageout));
            current_statement_begin__ = 87;
            stan::math::assign(sdyearout, sd(yearout));
            current_statement_begin__ = 88;
            stan::math::assign(sdBL_cumwlm, sd(BL_cumwlm));
            current_statement_begin__ = 89;
            stan::math::assign(sdBL_cumatwork, sd(BL_cumatwork));
            current_statement_begin__ = 90;
            stan::math::assign(sdcumatwork, sd(cumatwork));
            current_statement_begin__ = 91;
            stan::math::assign(sdcumwlm2lag, sd(cumwlm2lag));
            current_statement_begin__ = 96;
            for (int n = 1; n <= obscomplete; ++n) {
                current_statement_begin__ = 97;
                if (as_bool(logical_gt(get_base1(wlm,n,"wlm",1),0))) {
                    current_statement_begin__ = 97;
                    stan::math::assign(get_base1_lhs(logwlm,n,"logwlm",1), log(get_base1(wlm,n,"wlm",1)));
                } else {
                    current_statement_begin__ = 98;
                    stan::math::assign(get_base1_lhs(logwlm,n,"logwlm",1), 0.01);
                }
                current_statement_begin__ = 99;
                stan::math::assign(get_base1_lhs(ageoutcen,n,"ageoutcen",1), ((get_base1(ageout,n,"ageout",1) - meanageout) / sdageout));
                current_statement_begin__ = 100;
                stan::math::assign(get_base1_lhs(yearoutcen,n,"yearoutcen",1), ((get_base1(yearout,n,"yearout",1) - meanyearout) / sdyearout));
                ...
                stan::math::assign(get_base1_lhs(BL_cumatworkcen,n,"BL_cumatworkcen",1), ((get_base1(BL_cumatwork,n,"BL_cumatwork",1) - meanBL_cumatwork) / sdBL_cumatwork));
                current_statement_begin__ = 103;
                stan::math::assign(get_base1_lhs(cumatworkcen,n,"cumatworkcen",1), ((get_base1(cumatwork,n,"cumatwork",1) - meancumatwork) / sdcumatwork));
                ...
                stan::math::assign(get_base1_lhs(over50,n,"over50",1), logical_gt(get_base1(ageout,n,"ageout",1),50));
            }
            current_statement_begin__ = 108;
            for (int c = 1; c <= obs; ++c) {
                current_statement_begin__ = 109;
                stan::math::assign(get_base1_lhs(time_fullcen,c,"time_fullcen",1), ((get_base1(time_full,c,"time_full",1) - meanageout) / sdageout));
                current_statement_begin__ = 110;
                stan::math::assign(get_base1_lhs(year_fullcen,c,"year_fullcen",1), ((get_base1(year_full,c,"year_full",1) - meanyearout) / sdyearout));
                ...
                stan::math::assign(get_base1_lhs(BL_cumatwork_fullcen,c,"BL_cumatwork_fullcen",1), ((get_base1(BL_cumatwork_full,c,"BL_cumatwork_full",1) - meanBL_cumatwork) / sdBL_cumatwork));
            }
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        num_params_r__ += 14;
        num_params_r__ += 1;
        num_params_r__ += obscomplete;
    }

    ~cpum_bayesgf_20151101_model() { }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("z0")))
            throw std::runtime_error("variable z0 missing");
        vals_r__ = context__.vals_r("z0");
        pos__ = 0U;
        context__.validate_dims("initialization", "z0", "double", context__.to_vec());
        double z0(0);
        z0 = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(z0);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable z0: ") + e.what());
        }
        ...
        if (!(context__.contains_r("sigma2_z")))
            throw std::runtime_error("variable sigma2_z missing");
        vals_r__ = context__.vals_r("sigma2_z");
        pos__ = 0U;
        context__.validate_dims("initialization", "sigma2_z", "double", context__.to_vec());
        double sigma2_z(0);
        sigma2_z = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0,sigma2_z);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable sigma2_z: ") + e.what());
        }
        ...
        pos__ = 0U;
        context__.validate_dims("initialization", "a", "double", context__.to_vec(9));
        std::vector<double> a(9,double(0));
        for (int i0__ = 0U; i0__ < 9; ++i0__)
        ...
        pos__ = 0U;
        context__.validate_dims("initialization", "g", "double", context__.to_vec(9));
        std::vector<double> g(9,double(0));
        for (int i0__ = 0U; i0__ < 9; ++i0__)
        ...
        pos__ = 0U;
        context__.validate_dims("initialization", "b", "double", context__.to_vec(14));
        std::vector<double> b(14,double(0));
        for (int i0__ = 0U; i0__ < 14; ++i0__)
        ...
        pos__ = 0U;
        context__.validate_dims("initialization", "c", "double", context__.to_vec(14));
        std::vector<double> c(14,double(0));
        for (int i0__ = 0U; i0__ < 14; ++i0__)
        ...
        pos__ = 0U;
        context__.validate_dims("initialization", "z", "double", context__.to_vec(1));
        std::vector<double> z(1,double(0));
        ...
        if (!(context__.contains_r("berkson")))
            throw std::runtime_error("variable berkson missing");
        vals_r__ = context__.vals_r("berkson");
        pos__ = 0U;
        context__.validate_dims("initialization", "berkson", "row_vector_d", context__.to_vec(obscomplete));
        row_vector_d berkson(obscomplete);
        for (int j1__ = 0U; j1__ < obscomplete; ++j1__)
            berkson(j1__) = vals_r__[pos__++];
        try {
            writer__.row_vector_lb_unconstrain(0,berkson);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable berkson: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        T__ z0;
        (void) z0;   // dummy to suppress unused var warning
        if (jacobian__)
            z0 = in__.scalar_constrain(lp__);
        else
            z0 = in__.scalar_constrain();
        ...
        T__ sigma2_z;
        (void) sigma2_z;   // dummy to suppress unused var warning
        if (jacobian__)
            sigma2_z = in__.scalar_lb_constrain(0,lp__);
        else
            sigma2_z = in__.scalar_lb_constrain(0);
        ...
        Eigen::Matrix<T__,1,Eigen::Dynamic>  berkson;
        (void) berkson;   // dummy to suppress unused var warning
        if (jacobian__)
            berkson = in__.row_vector_lb_constrain(0,obscomplete,lp__);
        else
            berkson = in__.row_vector_lb_constrain(0,obscomplete);


        // transformed parameters
        T__ Q;
        (void) Q;  // dummy to suppress unused var warning
        Eigen::Matrix<T__,1,Eigen::Dynamic>  truecumwlm2lag(obscomplete);
        (void) truecumwlm2lag;  // dummy to suppress unused var warning
        stan::math::fill(truecumwlm2lag,DUMMY_VAR__);
        Eigen::Matrix<T__,1,Eigen::Dynamic>  truecumwlm2lagcen(obscomplete);
        (void) truecumwlm2lagcen;  // dummy to suppress unused var warning
        stan::math::fill(truecumwlm2lagcen,DUMMY_VAR__);
        Eigen::Matrix<T__,1,Eigen::Dynamic>  truewlm(obscomplete);
        (void) truewlm;  // dummy to suppress unused var warning
        stan::math::fill(truewlm,DUMMY_VAR__);
        ...
        try {
            ...
            stan::math::assign(Q, 1);
            current_statement_begin__ = 148;
            for (int n = 1; n <= obscomplete; ++n) {
                current_statement_begin__ = 149;
                stan::math::assign(get_base1_lhs(truewlm,n,"truewlm",1), (get_base1(wlm,n,"wlm",1) * get_base1(berkson,n,"berkson",1)));
                current_statement_begin__ = 150;
                if (as_bool((primitive_value(logical_lte(n,2)) || primitive_value(logical_neq(get_base1(id,n,"id",1),get_base1(id,(n - 2),"id",1)))))) {
                    current_statement_begin__ = 151;
                    stan::math::assign(get_base1_lhs(truecumwlm2lag,n,"truecumwlm2lag",1), 0);
                    current_statement_begin__ = 152;
                    stan::math::assign(get_base1_lhs(truecumwlm2lagcen,n,"truecumwlm2lagcen",1), 0);
                } else {
                    current_statement_begin__ = 155;
                    stan::math::assign(get_base1_lhs(truecumwlm2lag,n,"truecumwlm2lag",1), (get_base1(truecumwlm2lag,(n - 1),"truecumwlm2lag",1) + get_base1(truewlm,(n - 2),"truewlm",1)));
                    current_statement_begin__ = 156;
                    stan::math::assign(get_base1_lhs(truecumwlm2lagcen,n,"truecumwlm2lagcen",1), ((get_base1(truecumwlm2lag,n,"truecumwlm2lag",1) - meancumwlm2lag) / sdcumwlm2lag));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e,current_statement_begin__);
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        for (int i0__ = 0; i0__ < obscomplete; ++i0__) {
            if (stan::math::is_uninitialized(truecumwlm2lag(i0__))) {
                std::stringstream msg__;
                msg__ << "Undefined transformed parameter: truecumwlm2lag" << '[' << i0__ << ']';
                throw std::runtime_error(msg__.str());
            }
        }
        for (int i0__ = 0; i0__ < obscomplete; ++i0__) {
            if (stan::math::is_uninitialized(truecumwlm2lagcen(i0__))) {
                std::stringstream msg__;
                msg__ << "Undefined transformed parameter: truecumwlm2lagcen" << '[' << i0__ << ']';
                throw std::runtime_error(msg__.str());
            }
        }
        for (int i0__ = 0; i0__ < obscomplete; ++i0__) {
            if (stan::math::is_uninitialized(truewlm(i0__))) {
                std::stringstream msg__;
                msg__ << "Undefined transformed parameter: truewlm" << '[' << i0__ << ']';
                throw std::runtime_error(msg__.str());
            }
        }
        ...
        check_greater_or_equal(function__,"truewlm",truewlm,0);

        // model body
        try {
            current_statement_begin__ = 167;
            lp_accum__.add(normal_log<propto__>(a, 0, 11));
            current_statement_begin__ = 168;
            lp_accum__.add(normal_log<propto__>(b, 0, 11));
            current_statement_begin__ = 169;
            lp_accum__.add(normal_log<propto__>(c, 0, 11));
            current_statement_begin__ = 170;
            lp_accum__.add(normal_log<propto__>(g, 0, 11));
            current_statement_begin__ = 173;
            lp_accum__.add(inv_gamma_log<propto__>(sigma2, 0.10000000000000001, 0.10000000000000001));
            current_statement_begin__ = 176;
            lp_accum__.add(inv_gamma_log<propto__>(sigma2_z, 0.10000000000000001, 0.10000000000000001));
            current_statement_begin__ = 182;
            lp_accum__.add(normal_log<propto__>(log(berkson), -(0.5), 1));
            current_statement_begin__ = 186;
            lp_accum__.add(minus(log(berkson)));
            ...
            for (int n = 1; n <= obscomplete; ++n) {
                ...
                if (as_bool((primitive_value(logical_eq(get_base1(atwork,n,"atwork",1),1)) && primitive_value(logical_gt(get_base1(wlm,n,"wlm",1),0))))) {
                    ...
                    lp_accum__.add(normal_log<propto__>(log((get_base1(truewlm,n,"truewlm",1) / 1000)), (((((((((a0 + (get_base1(a,1,"a",1) * get_base1(BL_cumwlmcen,n,"BL_cumwlmcen",1))) + (get_base1(a,2,"a",1) * get_base1(BL_cumatworkcen,n,"BL_cumatworkcen",1))) + (get_base1(a,3,"a",1) * get_base1(cohort_1,n,"cohort_1",1))) + (get_base1(a,4,"a",1) * get_base1(cumatworkcen,n,"cumatworkcen",1))) + (get_base1(a,5,"a",1) * get_base1(truecumwlm2lagcen,n,"truecumwlm2lagcen",1))) + (get_base1(a,6,"a",1) * get_base1(ageoutcen,n,"ageoutcen",1))) + ((get_base1(a,7,"a",1) * get_base1(ageoutcen,n,"ageoutcen",1)) * get_base1(ageoutcen,n,"ageoutcen",1))) + (get_base1(a,8,"a",1) * get_base1(yearoutcen,n,"yearoutcen",1))) + ((get_base1(a,9,"a",1) * get_base1(yearoutcen,n,"yearoutcen",1)) * get_base1(yearoutcen,n,"yearoutcen",1))), sigma2));
                } else {
                    current_statement_begin__ = 213;
                    lp_accum__.add(0);
                }
                current_statement_begin__ = 218;
                if (as_bool((primitive_value(logical_eq(get_base1(atwork,n,"atwork",1),1)) || primitive_value(logical_eq(get_base1(leftwork,n,"leftwork",1),1))))) {
                    current_statement_begin__ = 219;
                    lp_accum__.add(bernoulli_logit_log<propto__>(get_base1(leftwork,n,"leftwork",1), (((((((((g0 + (get_base1(g,1,"g",1) * get_base1(BL_cumwlmcen,n,"BL_cumwlmcen",1))) + (get_base1(g,2,"g",1) * get_base1(BL_cumatworkcen,n,"BL_cumatworkcen",1))) + (get_base1(g,3,"g",1) * get_base1(cohort_1,n,"cohort_1",1))) + (get_base1(g,4,"g",1) * get_base1(cumatworkcen,n,"cumatworkcen",1))) + (get_base1(g,5,"g",1) * get_base1(truecumwlm2lagcen,n,"truecumwlm2lagcen",1))) + (get_base1(g,6,"g",1) * get_base1(ageoutcen,n,"ageoutcen",1))) + ((get_base1(g,7,"g",1) * get_base1(ageoutcen,n,"ageoutcen",1)) * get_base1(ageoutcen,n,"ageoutcen",1))) + (get_base1(g,8,"g",1) * get_base1(yearoutcen,n,"yearoutcen",1))) + ((get_base1(g,9,"g",1) * get_base1(yearoutcen,n,"yearoutcen",1)) * get_base1(yearoutcen,n,"yearoutcen",1)))));
                } else {
            ...
            lp_accum__.add(bernoulli_logit_log<propto__>(d_lc, add(add(add(add(add(add(add(add(add(add(add(add(add(add(b0,multiply(get_base1(b,1,"b",1),BL_cumwlmcen)),multiply(get_base1(b,2,"b",1),BL_cumatworkcen)),multiply(get_base1(b,3,"b",1),cohort_1)),multiply(get_base1(b,4,"b",1),cumatworkcen)),multiply(get_base1(b,5,"b",1),atwork2lag)),multiply(get_base1(b,6,"b",1),truecumwlm2lagcen)),multiply(get_base1(b,7,"b",1),ageoutcen)),elt_multiply(multiply(get_base1(b,8,"b",1),ageoutcen),ageoutcen)),elt_multiply(elt_multiply(multiply(get_base1(b,9,"b",1),ageoutcen),ageoutcen),ageoutcen)),elt_multiply(elt_multiply(elt_multiply(multiply(get_base1(b,10,"b",1),ageoutcen),ageoutcen),ageoutcen),ageoutcen)),elt_multiply(multiply(get_base1(b,11,"b",1),atwork),cumwlm2lagcen)),elt_multiply(multiply(get_base1(b,12,"b",1),cumatworkcen),cumatworkcen)),multiply(get_base1(b,13,"b",1),yearoutcen)),elt_multiply(multiply(get_base1(b,14,"b",1),yearoutcen),yearoutcen))));
            current_statement_begin__ = 244;
            lp_accum__.add(bernoulli_logit_log<propto__>(d_nonlc, add(add(add(add(add(add(add(add(add(add(add(add(add(add(c0,multiply(get_base1(c,1,"c",1),BL_cumwlmcen)),multiply(get_base1(c,2,"c",1),BL_cumatworkcen)),multiply(get_base1(c,3,"c",1),cohort_1)),multiply(get_base1(c,4,"c",1),cumatworkcen)),multiply(get_base1(c,5,"c",1),atwork2lag)),multiply(get_base1(c,6,"c",1),truecumwlm2lagcen)),multiply(get_base1(c,7,"c",1),ageoutcen)),elt_multiply(multiply(get_base1(c,8,"c",1),ageoutcen),ageoutcen)),elt_multiply(elt_multiply(multiply(get_base1(c,9,"c",1),ageoutcen),ageoutcen),ageoutcen)),elt_multiply(elt_multiply(elt_multiply(multiply(get_base1(c,10,"c",1),ageoutcen),ageoutcen),ageoutcen),ageoutcen)),elt_multiply(multiply(get_base1(c,11,"c",1),atwork),cumwlm2lagcen)),elt_multiply(multiply(get_base1(c,12,"c",1),cumatworkcen),cumatworkcen)),multiply(get_base1(c,13,"c",1),yearoutcen)),elt_multiply(multiply(get_base1(c,14,"c",1),yearoutcen),yearoutcen))));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e,current_statement_begin__);
            // Next line prevents compiler griping about no return
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("z0");
        names__.push_back("sigma2");
        names__.push_back("sigma2_z");
        names__.push_back("a");
        names__.push_back("g");
        names__.push_back("b");
        names__.push_back("c");
        names__.push_back("z");
        names__.push_back("berkson");
        names__.push_back("Q");
        names__.push_back("truecumwlm2lag");
        names__.push_back("truecumwlm2lagcen");
        names__.push_back("truewlm");
        names__.push_back("surv_nc");
        names__.push_back("cilc_nc");
        names__.push_back("cinlc_nc");
        names__.push_back("surv_2");
        names__.push_back("cilc_2");
        names__.push_back("cinlc_2");
        names__.push_back("surv_1");
        names__.push_back("cilc_1");
        names__.push_back("cinlc_1");
        names__.push_back("surv_33");
        names__.push_back("cilc_33");
        names__.push_back("cinlc_33");
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "cpum_bayesgf_20151101_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
        ...
        double z0 = in__.scalar_constrain();
        double sigma2 = in__.scalar_lb_constrain(0);
        double sigma2_z = in__.scalar_lb_constrain(0);
        vector<double> a;
        size_t dim_a_0__ = 9;
        for (size_t k_0__ = 0; k_0__ < dim_a_0__; ++k_0__) {
            a.push_back(in__.scalar_constrain());
        ...
        row_vector_d berkson = in__.row_vector_lb_constrain(0,obscomplete);
        vars__.push_back(a0);
        vars__.push_back(b0);
        vars__.push_back(c0);
        vars__.push_back(g0);
        ...
        for (int k_0__ = 0; k_0__ < 14; ++k_0__) {
        ...
        for (int k_0__ = 0; k_0__ < obscomplete; ++k_0__) {
            vars__.push_back(berkson[k_0__]);
        }
        ...
        double Q(0.0);
        (void) Q;  // dummy to suppress unused var warning
        row_vector_d truecumwlm2lag(obscomplete);
        (void) truecumwlm2lag;  // dummy to suppress unused var warning
        row_vector_d truecumwlm2lagcen(obscomplete);
        (void) truecumwlm2lagcen;  // dummy to suppress unused var warning
        row_vector_d truewlm(obscomplete);
        (void) truewlm;  // dummy to suppress unused var warning
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        vars__.push_back(Q);
        for (int k_0__ = 0; k_0__ < obscomplete; ++k_0__) {
            vars__.push_back(truecumwlm2lag[k_0__]);
        }
        for (int k_0__ = 0; k_0__ < obscomplete; ++k_0__) {
            vars__.push_back(truecumwlm2lagcen[k_0__]);
        }
        for (int k_0__ = 0; k_0__ < obscomplete; ++k_0__) {
            vars__.push_back(truewlm[k_0__]);
        }
        ...
        stan::math::fill(surv_2,DUMMY_VAR__);
        stan::math::fill(cilc_2,DUMMY_VAR__);
        stan::math::fill(cinlc_2,DUMMY_VAR__);
        stan::math::fill(surv_1,DUMMY_VAR__);
        stan::math::fill(cilc_1,DUMMY_VAR__);
        stan::math::fill(cinlc_1,DUMMY_VAR__);
        stan::math::fill(surv_33,DUMMY_VAR__);
        stan::math::fill(cilc_33,DUMMY_VAR__);
        stan::math::fill(cinlc_33,DUMMY_VAR__);
        ...
        try {
            {
                ...
                stan::math::initialize(leftworkf, std::numeric_limits<double>::quiet_NaN());
                ...
                stan::math::initialize(cumxcen, std::numeric_limits<double>::quiet_NaN());
                ...
                for (int interv = 1; interv <= 4; ++interv) {
                    ...
                    for (int n = 1; n <= obs; ++n) {
                        ...
                        stan::math::assign(get_base1_lhs(cumxcen,n,"cumxcen",1), 0);
                        current_statement_begin__ = 345;
                        stan::math::assign(get_base1_lhs(cumlcen,n,"cumlcen",1), 0);
                        ...
                        stan::math::assign(get_base1_lhs(cumx2lagcen,n,"cumx2lagcen",1), 0);
                    ...
                    for (int n = 1; n <= obs; ++n) {
                        ...
                        if (as_bool((primitive_value(logical_eq(n,1)) || primitive_value(logical_neq(get_base1(id_full,n,"id_full",1),get_base1(id_full,(n - 1),"id_full",1)))))) {
                            ...
                            stan::math::assign(lswitch, 1);
                        }
                        current_statement_begin__ = 371;
                        if (as_bool(logical_eq(lswitch,1))) {
                            current_statement_begin__ = 372;
                            stan::math::assign(get_base1_lhs(leftworkf,n,"leftworkf",1), bernoulli_rng(inv_logit((((((((((g0 + (get_base1(g,1,"g",1) * get_base1(BL_cumwlm_fullcen,n,"BL_cumwlm_fullcen",1))) + (get_base1(g,2,"g",1) * get_base1(BL_cumatwork_fullcen,n,"BL_cumatwork_fullcen",1))) + (get_base1(g,3,"g",1) * get_base1(cohort_1_full,n,"cohort_1_full",1))) + (get_base1(g,4,"g",1) * get_base1(cumlcen,n,"cumlcen",1))) + (get_base1(g,5,"g",1) * get_base1(cumx2lagcen,n,"cumx2lagcen",1))) + (get_base1(g,6,"g",1) * get_base1(time_fullcen,n,"time_fullcen",1))) + ((get_base1(g,7,"g",1) * get_base1(time_fullcen,n,"time_fullcen",1)) * get_base1(time_fullcen,n,"time_fullcen",1))) + (get_base1(g,8,"g",1) * get_base1(year_fullcen,n,"year_fullcen",1))) + ((get_base1(g,9,"g",1) * get_base1(year_fullcen,n,"year_fullcen",1)) * get_base1(year_fullcen,n,"year_fullcen",1)))), base_rng__));
                            current_statement_begin__ = 377;
                            if (as_bool((primitive_value(logical_eq(n,1)) || primitive_value(logical_neq(get_base1(id_full,n,"id_full",1),get_base1(id_full,(n - 1),"id_full",1)))))) {
                                current_statement_begin__ = 377;
                                stan::math::assign(get_base1_lhs(leftworkf,n,"leftworkf",1), 0);
                            }
                            current_statement_begin__ = 378;
                            if (as_bool(logical_eq(get_base1(leftworkf,n,"leftworkf",1),1))) {
                                current_statement_begin__ = 379;
                                stan::math::assign(get_base1_lhs(lhat,n,"lhat",1), 0);
                                current_statement_begin__ = 380;
                                stan::math::assign(lswitch, 0);
                            } else {
                        ...
                        if (as_bool(logical_eq(get_base1(lhat,n,"lhat",1),1))) {
                            ...
                            stan::math::assign(get_base1_lhs(xhat,n,"xhat",1), (1000 * exp(normal_rng((((((((((a0 + (get_base1(a,1,"a",1) * get_base1(BL_cumwlm_fullcen,n,"BL_cumwlm_fullcen",1))) + (get_base1(a,2,"a",1) * get_base1(BL_cumatwork_fullcen,n,"BL_cumatwork_fullcen",1))) + (get_base1(a,3,"a",1) * get_base1(cohort_1_full,n,"cohort_1_full",1))) + (get_base1(a,4,"a",1) * get_base1(cumlcen,n,"cumlcen",1))) + (get_base1(a,5,"a",1) * get_base1(cumx2lagcen,n,"cumx2lagcen",1))) + (get_base1(a,6,"a",1) * get_base1(time_fullcen,n,"time_fullcen",1))) + ((get_base1(a,7,"a",1) * get_base1(time_fullcen,n,"time_fullcen",1)) * get_base1(time_fullcen,n,"time_fullcen",1))) + (get_base1(a,8,"a",1) * get_base1(year_fullcen,n,"year_fullcen",1))) + ((get_base1(a,9,"a",1) * get_base1(year_fullcen,n,"year_fullcen",1)) * get_base1(year_fullcen,n,"year_fullcen",1))),sigma2, base_rng__))));
                        ...
                        if (as_bool((primitive_value(logical_eq(interv,2)) && primitive_value(logical_gt(get_base1(xhat,n,"xhat",1),24))))) {
                            current_statement_begin__ = 403;
                            stan::math::assign(get_base1_lhs(xhat,n,"xhat",1), 24);
                        }
                        current_statement_begin__ = 405;
                        if (as_bool((primitive_value(logical_eq(interv,3)) && primitive_value(logical_gt(get_base1(xhat,n,"xhat",1),12))))) {
                            current_statement_begin__ = 406;
                            stan::math::assign(get_base1_lhs(xhat,n,"xhat",1), 12);
                        }
                        current_statement_begin__ = 408;
                        if (as_bool((primitive_value(logical_eq(interv,4)) && primitive_value(logical_gt(get_base1(xhat,n,"xhat",1),4))))) {
                        ...
                        if (as_bool((primitive_value(logical_gt(n,1)) && primitive_value(logical_eq(get_base1(id_full,n,"id_full",1),get_base1(id_full,(n - 1),"id_full",1)))))) {
                            ...
                            stan::math::assign(get_base1_lhs(cumlcen,n,"cumlcen",1), ((get_base1(cuml,n,"cuml",1) - meancumatwork) / sdcumatwork));
                        }
                        ...
                        stan::math::assign(get_base1_lhs(h_lcn,n,"h_lcn",1), inv_logit(((((((((((((((b0 + (get_base1(b,1,"b",1) * get_base1(BL_cumwlm_fullcen,n,"BL_cumwlm_fullcen",1))) + (get_base1(b,2,"b",1) * get_base1(BL_cumatwork_fullcen,n,"BL_cumatwork_fullcen",1))) + (get_base1(b,3,"b",1) * get_base1(cohort_1_full,n,"cohort_1_full",1))) + (get_base1(b,4,"b",1) * get_base1(cumlcen,n,"cumlcen",1))) + (get_base1(b,5,"b",1) * get_base1(lhat2lag,n,"lhat2lag",1))) + (get_base1(b,6,"b",1) * get_base1(cumx2lagcen,n,"cumx2lagcen",1))) + (get_base1(b,7,"b",1) * get_base1(time_fullcen,n,"time_fullcen",1))) + ((get_base1(b,8,"b",1) * get_base1(time_fullcen,n,"time_fullcen",1)) * get_base1(time_fullcen,n,"time_fullcen",1))) + (((get_base1(b,9,"b",1) * get_base1(time_fullcen,n,"time_fullcen",1)) * get_base1(time_fullcen,n,"time_fullcen",1)) * get_base1(time_fullcen,n,"time_fullcen",1))) + ((((get_base1(b,10,"b",1) * get_base1(time_fullcen,n,"time_fullcen",1)) * get_base1(time_fullcen,n,"time_fullcen",1)) * get_base1(time_fullcen,n,"time_fullcen",1)) * get_base1(time_fullcen,n,"time_fullcen",1))) + ((get_base1(b,11,"b",1) * get_base1(lhat,n,"lhat",1)) * get_base1(cumx2lagcen,n,"cumx2lagcen",1))) + ((get_base1(b,12,"b",1) * get_base1(cumlcen,n,"cumlcen",1)) * get_base1(cumlcen,n,"cumlcen",1))) + (get_base1(b,13,"b",1) * get_base1(year_fullcen,n,"year_fullcen",1))) + ((get_base1(b,14,"b",1) * get_base1(year_fullcen,n,"year_fullcen",1)) * get_base1(year_fullcen,n,"year_fullcen",1)))));
                        current_statement_begin__ = 443;
                        stan::math::assign(get_base1_lhs(h_nlcn,n,"h_nlcn",1), inv_logit(((((((((((((((c0 + (get_base1(c,1,"c",1) * get_base1(BL_cumwlm_fullcen,n,"BL_cumwlm_fullcen",1))) + (get_base1(c,2,"c",1) * get_base1(BL_cumatwork_fullcen,n,"BL_cumatwork_fullcen",1))) + (get_base1(c,3,"c",1) * get_base1(cohort_1_full,n,"cohort_1_full",1))) + (get_base1(c,4,"c",1) * get_base1(cumlcen,n,"cumlcen",1))) + (get_base1(c,5,"c",1) * get_base1(lhat2lag,n,"lhat2lag",1))) + (get_base1(c,6,"c",1) * get_base1(cumx2lagcen,n,"cumx2lagcen",1))) + (get_base1(c,7,"c",1) * get_base1(time_fullcen,n,"time_fullcen",1))) + ((get_base1(c,8,"c",1) * get_base1(time_fullcen,n,"time_fullcen",1)) * get_base1(time_fullcen,n,"time_fullcen",1))) + (((get_base1(c,9,"c",1) * get_base1(time_fullcen,n,"time_fullcen",1)) * get_base1(time_fullcen,n,"time_fullcen",1)) * get_base1(time_fullcen,n,"time_fullcen",1))) + ((((get_base1(c,10,"c",1) * get_base1(time_fullcen,n,"time_fullcen",1)) * get_base1(time_fullcen,n,"time_fullcen",1)) * get_base1(time_fullcen,n,"time_fullcen",1)) * get_base1(time_fullcen,n,"time_fullcen",1))) + ((get_base1(c,11,"c",1) * get_base1(lhat,n,"lhat",1)) * get_base1(cumx2lagcen,n,"cumx2lagcen",1))) + ((get_base1(c,12,"c",1) * get_base1(cumlcen,n,"cumlcen",1)) * get_base1(cumlcen,n,"cumlcen",1))) + (get_base1(c,13,"c",1) * get_base1(year_fullcen,n,"year_fullcen",1))) + ((get_base1(c,14,"c",1) * get_base1(year_fullcen,n,"year_fullcen",1)) * get_base1(year_fullcen,n,"year_fullcen",1)))));
                        current_statement_begin__ = 454;
                        for (int k = 1; k <= J; ++k) {
                            current_statement_begin__ = 456;
                            if (as_bool(logical_eq(get_base1(time_full,n,"time_full",1),((k + minT) - 1)))) {
                        ...
                        if (as_bool((primitive_value(logical_eq(get_base1(time_full,n,"time_full",1),maxT)) || primitive_value(logical_eq(get_base1(time_full,n,"time_full",1),get_base1(maxage_full,n,"maxage_full",1)))))) {
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        for (int k_0__ = 0; k_0__ < J; ++k_0__) {
            vars__.push_back(surv_2[k_0__]);
        }
        for (int k_0__ = 0; k_0__ < J; ++k_0__) {
            vars__.push_back(cilc_2[k_0__]);
        }
        for (int k_0__ = 0; k_0__ < J; ++k_0__) {
            vars__.push_back(cinlc_2[k_0__]);
        }
        for (int k_0__ = 0; k_0__ < J; ++k_0__) {
            vars__.push_back(surv_1[k_0__]);
        }
        for (int k_0__ = 0; k_0__ < J; ++k_0__) {
            vars__.push_back(cilc_1[k_0__]);
        }
        for (int k_0__ = 0; k_0__ < J; ++k_0__) {
            vars__.push_back(cinlc_1[k_0__]);
        }
        for (int k_0__ = 0; k_0__ < J; ++k_0__) {
            vars__.push_back(surv_33[k_0__]);
        }
        for (int k_0__ = 0; k_0__ < J; ++k_0__) {
            vars__.push_back(cilc_33[k_0__]);
        }
        for (int k_0__ = 0; k_0__ < J; ++k_0__) {
            vars__.push_back(cinlc_33[k_0__]);
        }
    ...
    static std::string model_name() {
        return "cpum_bayesgf_20151101_model";
    }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "z0";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "sigma2";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "sigma2_z";
        param_names__.push_back(param_name_stream__.str());
        ...
        for (int k_0__ = 1; k_0__ <= 14; ++k_0__) {
            param_name_stream__.str(std::string());
        ...
        for (int k_0__ = 1; k_0__ <= obscomplete; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "berkson" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        ...
        for (int k_0__ = 1; k_0__ <= obscomplete; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "truecumwlm2lag" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= obscomplete; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "truecumwlm2lagcen" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= obscomplete; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "truewlm" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        ...
        for (int k_0__ = 1; k_0__ <= J; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "surv_2" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= J; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "cilc_2" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= J; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "cinlc_2" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= J; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "surv_1" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= J; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "cilc_1" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= J; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "cinlc_1" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= J; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "surv_33" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= J; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "cilc_33" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= J; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "cinlc_33" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
...
typedef cpum_bayesgf_20151101_model_namespace::cpum_bayesgf_20151101_model stan_model;
