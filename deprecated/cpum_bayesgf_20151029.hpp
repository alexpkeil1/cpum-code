...
namespace cpum_bayesgf_20151029_model_namespace {
...
class cpum_bayesgf_20151029_model : public prob_grad {
private:
    int N;
    int J;
    int minT;
    ...
    double sdcumwlm2lag;
public:
    cpum_bayesgf_20151029_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        current_statement_begin__ = -1;

        static const char* function__ = "cpum_bayesgf_20151029_model_namespace::cpum_bayesgf_20151029_model";
        ...
        try {
            ...
            for (int n = 1; n <= obscomplete; ++n) {
                ...
                if (as_bool((primitive_value(logical_eq(get_base1(atwork,n,"atwork",1),1)) && primitive_value(logical_gt(get_base1(wlm,n,"wlm",1),0))))) {
                    ...
                    lp_accum__.add(normal_log<propto__>(log((get_base1(wlm,n,"wlm",1) / 1000)), (((((((((a0 + (get_base1(a,1,"a",1) * get_base1(BL_cumwlmcen,n,"BL_cumwlmcen",1))) + (get_base1(a,2,"a",1) * get_base1(BL_cumatworkcen,n,"BL_cumatworkcen",1))) + (get_base1(a,3,"a",1) * get_base1(cohort_1,n,"cohort_1",1))) + (get_base1(a,4,"a",1) * get_base1(cumatworkcen,n,"cumatworkcen",1))) + (get_base1(a,5,"a",1) * get_base1(cumwlm2lagcen,n,"cumwlm2lagcen",1))) + (get_base1(a,6,"a",1) * get_base1(ageoutcen,n,"ageoutcen",1))) + ((get_base1(a,7,"a",1) * get_base1(ageoutcen,n,"ageoutcen",1)) * get_base1(ageoutcen,n,"ageoutcen",1))) + (get_base1(a,8,"a",1) * get_base1(yearoutcen,n,"yearoutcen",1))) + ((get_base1(a,9,"a",1) * get_base1(yearoutcen,n,"yearoutcen",1)) * get_base1(yearoutcen,n,"yearoutcen",1))), sigma2));
                } else {
                ...
                if (as_bool((primitive_value(logical_eq(get_base1(atwork,n,"atwork",1),1)) || primitive_value(logical_eq(get_base1(leftwork,n,"leftwork",1),1))))) {
                    ...
                    lp_accum__.add(bernoulli_logit_log<propto__>(get_base1(leftwork,n,"leftwork",1), (((((((((g0 + (get_base1(g,1,"g",1) * get_base1(BL_cumwlmcen,n,"BL_cumwlmcen",1))) + (get_base1(g,2,"g",1) * get_base1(BL_cumatworkcen,n,"BL_cumatworkcen",1))) + (get_base1(g,3,"g",1) * get_base1(cohort_1,n,"cohort_1",1))) + (get_base1(g,4,"g",1) * get_base1(cumatworkcen,n,"cumatworkcen",1))) + (get_base1(g,5,"g",1) * get_base1(cumwlm2lagcen,n,"cumwlm2lagcen",1))) + (get_base1(g,6,"g",1) * get_base1(ageoutcen,n,"ageoutcen",1))) + ((get_base1(g,7,"g",1) * get_base1(ageoutcen,n,"ageoutcen",1)) * get_base1(ageoutcen,n,"ageoutcen",1))) + (get_base1(g,8,"g",1) * get_base1(yearoutcen,n,"yearoutcen",1))) + ((get_base1(g,9,"g",1) * get_base1(yearoutcen,n,"yearoutcen",1)) * get_base1(yearoutcen,n,"yearoutcen",1)))));
                } else {
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "cpum_bayesgf_20151029_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    static std::string model_name() {
        return "cpum_bayesgf_20151029_model";
    }
...
typedef cpum_bayesgf_20151029_model_namespace::cpum_bayesgf_20151029_model stan_model;
