...
keep2 <- c("id","minage", "maxage", "agein", "ageout", "dateout", "wlm", "cumwlm", "wlm_2_10", "cumwlm2lag",
          ...
          "BL_cumwlm", "BL_cumyrsexp", "priorwlm", "cumwlm10lag")
...
summary(glm(d_lc ~ I(ageout*dateout) + BL_cumwlm + BL_cumyrsexp + cumyrsexp + I(cumyrsexp^2) + cumwlm2lag + I(cumwlm2lag^2) + ageout + I(ageout^2)+ I(ageout^3) + dateout + I(dateout^2), data=dat[dat$race==2 & !is.na(dat$smoke3_2),], family=binomial))
dsummary(glm(d_nonlc ~ BL_cumwlm + BL_cumyrsexp  + cumwlm2lag  + ageout + I(ageout^2) + dateout + I(dateout^2), data=dat[dat$race==2 & !is.na(dat$smoke3_2),], family=binomial))
