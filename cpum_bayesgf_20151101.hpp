...
public:
    cpum_bayesgf_20151101_model(stan::io::var_context& context__,
        ...
        context__.validate_dims("data initialization", "priorwlm", "row_vector_d", context__.to_vec(obscomplete));
        validate_non_negative_index("priorwlm", "obscomplete", obscomplete);
        priorwlm = row_vector_d(obscomplete);
        vals_r__ = context__.vals_r("priorwlm");
        pos__ = 0;
        size_t priorwlm_i_vec_lim__ = obscomplete;
        for (size_t i_vec__ = 0; i_vec__ < priorwlm_i_vec_lim__; ++i_vec__) {
            priorwlm[i_vec__] = vals_r__[pos__++];
        }
        ...
        context__.validate_dims("data initialization", "priorwlm_full", "row_vector_d", context__.to_vec(obs));
        validate_non_negative_index("priorwlm_full", "obs", obs);
        priorwlm_full = row_vector_d(obs);
        vals_r__ = context__.vals_r("priorwlm_full");
        pos__ = 0;
        size_t priorwlm_full_i_vec_lim__ = obs;
        for (size_t i_vec__ = 0; i_vec__ < priorwlm_full_i_vec_lim__; ++i_vec__) {
            priorwlm_full[i_vec__] = vals_r__[pos__++];
        }
        ...
        validate_non_negative_index("priorwlmcen", "obscomplete", obscomplete);
        priorwlmcen = row_vector_d(obscomplete);
        ...
        validate_non_negative_index("priorwlm_fullcen", "obs", obs);
        priorwlm_fullcen = row_vector_d(obs);
        meanageout = double(0);
        sdageout = double(0);
        ...
        stan::math::fill(priorwlmcen,DUMMY_VAR__);
        ...
        stan::math::fill(priorwlm_fullcen,DUMMY_VAR__);
        ...
        stan::math::fill(meanpriorwlm,DUMMY_VAR__);
        stan::math::fill(sdpriorwlm,DUMMY_VAR__);
        ...
        try {
            ...
            stan::math::assign(meanpriorwlm, mean(priorwlm));
            current_statement_begin__ = 96;
            stan::math::assign(sdpriorwlm, sd(priorwlm));
            ...
            for (int n = 1; n <= obscomplete; ++n) {
                ...
                stan::math::assign(get_base1_lhs(priorwlmcen,n,"priorwlmcen",1), ((get_base1(priorwlmcen,n,"priorwlmcen",1) - meanpriorwlm) / sdpriorwlm));
            }
            ...
            for (int c = 1; c <= obs; ++c) {
                ...
                stan::math::assign(get_base1_lhs(year_fullcen,c,"year_fullcen",1), ((get_base1(year_full,c,"year_full",1) - meandateout) / sddateout));
                ...
                stan::math::assign(get_base1_lhs(priorwlm_fullcen,c,"priorwlm_fullcen",1), ((get_base1(priorwlm_fullcen,c,"priorwlm_fullcen",1) - meanpriorwlm) / sdpriorwlm));
            }
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(z0, 0, 1));
            current_statement_begin__ = 156;
            lp_accum__.add(inv_gamma_log<propto__>(sigma2_z, 10, 1));
            current_statement_begin__ = 163;
            lp_accum__.add(normal_log<propto__>(log(berkson), z0, sigma2_z));
            ...
            lp_accum__.add(minus(log(berkson)));
            {
                ...
                stan::math::initialize(truecumwlm2lag, DUMMY_VAR__);
                stan::math::initialize(truecumwlm2lagcen, DUMMY_VAR__);
                stan::math::initialize(truewlm, DUMMY_VAR__);
                ...
                for (int n = 1; n <= obscomplete; ++n) {
                    ...
                    if (as_bool((primitive_value(logical_eq(get_base1(atwork,n,"atwork",1),1)) || primitive_value(logical_eq(get_base1(leftwork,n,"leftwork",1),1))))) {
                        ...
                        lp_accum__.add(bernoulli_logit_log<propto__>(get_base1(leftwork,n,"leftwork",1), (((((((((g0 + (get_base1(g,1,"g",1) * get_base1(BL_cumwlmcen,n,"BL_cumwlmcen",1))) + (get_base1(g,2,"g",1) * get_base1(BL_cumyrsexpcen,n,"BL_cumyrsexpcen",1))) + (get_base1(g,3,"g",1) * get_base1(cohort_1,n,"cohort_1",1))) + (get_base1(g,4,"g",1) * get_base1(cumyrsexpcen,n,"cumyrsexpcen",1))) + (get_base1(g,5,"g",1) * get_base1(truecumwlm2lagcen,n,"truecumwlm2lagcen",1))) + (get_base1(g,6,"g",1) * get_base1(ageoutcen,n,"ageoutcen",1))) + ((get_base1(g,7,"g",1) * get_base1(ageoutcen,n,"ageoutcen",1)) * get_base1(ageoutcen,n,"ageoutcen",1))) + (get_base1(g,8,"g",1) * get_base1(dateoutcen,n,"dateoutcen",1))) + ((get_base1(g,9,"g",1) * get_base1(dateoutcen,n,"dateoutcen",1)) * get_base1(dateoutcen,n,"dateoutcen",1)))));
                    } else {
                    ...
                    if (as_bool((primitive_value(logical_eq(get_base1(atwork,n,"atwork",1),1)) && primitive_value(logical_gt(get_base1(wlm,n,"wlm",1),0))))) {
                        ...
                        lp_accum__.add(normal_log<propto__>(log((get_base1(truewlm,n,"truewlm",1) / 1000)), (((((((((a0 + (get_base1(a,1,"a",1) * get_base1(BL_cumwlmcen,n,"BL_cumwlmcen",1))) + (get_base1(a,2,"a",1) * get_base1(BL_cumyrsexpcen,n,"BL_cumyrsexpcen",1))) + (get_base1(a,3,"a",1) * get_base1(cohort_1,n,"cohort_1",1))) + (get_base1(a,4,"a",1) * get_base1(cumyrsexpcen,n,"cumyrsexpcen",1))) + (get_base1(a,5,"a",1) * get_base1(truecumwlm2lagcen,n,"truecumwlm2lagcen",1))) + (get_base1(a,6,"a",1) * get_base1(ageoutcen,n,"ageoutcen",1))) + ((get_base1(a,7,"a",1) * get_base1(ageoutcen,n,"ageoutcen",1)) * get_base1(ageoutcen,n,"ageoutcen",1))) + (get_base1(a,8,"a",1) * get_base1(dateoutcen,n,"dateoutcen",1))) + ((get_base1(a,9,"a",1) * get_base1(dateoutcen,n,"dateoutcen",1)) * get_base1(dateoutcen,n,"dateoutcen",1))), sigma2));
                        current_statement_begin__ = 217;
                        lp_accum__.add(-(log((get_base1(truewlm,n,"truewlm",1) / 1000))));
                    } else {
                ...
                lp_accum__.add(bernoulli_logit_log<propto__>(d_lc, add(add(add(add(add(add(add(add(add(add(add(add(add(add(b0,multiply(get_base1(b,1,"b",1),BL_cumwlmcen)),multiply(get_base1(b,2,"b",1),BL_cumyrsexpcen)),multiply(get_base1(b,3,"b",1),cohort_1)),multiply(get_base1(b,4,"b",1),cumyrsexpcen)),multiply(get_base1(b,5,"b",1),priorwlmcen)),multiply(get_base1(b,6,"b",1),truecumwlm2lagcen)),multiply(get_base1(b,7,"b",1),ageoutcen)),elt_multiply(multiply(get_base1(b,8,"b",1),ageoutcen),ageoutcen)),elt_multiply(elt_multiply(multiply(get_base1(b,9,"b",1),ageoutcen),ageoutcen),ageoutcen)),elt_multiply(elt_multiply(elt_multiply(multiply(get_base1(b,10,"b",1),ageoutcen),ageoutcen),ageoutcen),ageoutcen)),elt_multiply(multiply(get_base1(b,11,"b",1),atwork),truecumwlm2lagcen)),elt_multiply(multiply(get_base1(b,12,"b",1),cumyrsexpcen),cumyrsexpcen)),multiply(get_base1(b,13,"b",1),dateoutcen)),elt_multiply(multiply(get_base1(b,14,"b",1),dateoutcen),dateoutcen))));
                current_statement_begin__ = 237;
                lp_accum__.add(bernoulli_logit_log<propto__>(d_nonlc, add(add(add(add(add(add(add(add(add(add(add(add(add(add(c0,multiply(get_base1(c,1,"c",1),BL_cumwlmcen)),multiply(get_base1(c,2,"c",1),BL_cumyrsexpcen)),multiply(get_base1(c,3,"c",1),cohort_1)),multiply(get_base1(c,4,"c",1),cumyrsexpcen)),multiply(get_base1(c,5,"c",1),priorwlmcen)),multiply(get_base1(c,6,"c",1),truecumwlm2lagcen)),multiply(get_base1(c,7,"c",1),ageoutcen)),elt_multiply(multiply(get_base1(c,8,"c",1),ageoutcen),ageoutcen)),elt_multiply(elt_multiply(multiply(get_base1(c,9,"c",1),ageoutcen),ageoutcen),ageoutcen)),elt_multiply(elt_multiply(elt_multiply(multiply(get_base1(c,10,"c",1),ageoutcen),ageoutcen),ageoutcen),ageoutcen)),elt_multiply(multiply(get_base1(c,11,"c",1),atwork),truecumwlm2lagcen)),elt_multiply(multiply(get_base1(c,12,"c",1),cumyrsexpcen),cumyrsexpcen)),multiply(get_base1(c,13,"c",1),dateoutcen)),elt_multiply(multiply(get_base1(c,14,"c",1),dateoutcen),dateoutcen))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e,current_statement_begin__);
            // Next line prevents compiler griping about no return
